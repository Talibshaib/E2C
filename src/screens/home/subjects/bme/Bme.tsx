  ...
  return (
    <View style={{flex: 1}}>
      <View style={{backgroundColor: '#5178C9', height: 261}}>
        ...
        <View style={styles.SecondContainer}>
          ...
          <View
            ...
            <View>
              <Text style={styles.userName}>BT203-BME (Basic Mechanical Engineering)</Text>
      ...
      <View
        ...
        <View style={{  gap:15, height:528}} >
        
         <ClickBoxSub  text="  Unit 1-Material"/>
         <ClickBoxSub  text="Unit 2-Measurement& Production  "/>
         <ClickBoxSub  text=" Unit 3-Fluids"/>
         <ClickBoxSub  text=" Unit 4-Thermodynamics"/>
         <ClickBoxSub  text=" Unit 5-Reciprocating Machine"/>
        </View>

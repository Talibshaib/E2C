    ...
    <View style={{flex: 1}}>
      <View style={{backgroundColor: '#5178C9', height: 261}}>
        ...
        <View style={styles.SecondContainer}>
          ...
          <View
            ...
            <View>
              <Text style={styles.userName}>BT202-Mathematics-II</Text>
      ...
      <View
        ...
        <View style={{  gap:12, height:528}} >
         ...
         <ClickBoxSub  text=" Unit 1-Ordinary Differential Equat-I"/>
         <ClickBoxSub  text="Unit 2-Ordinary Differential Equat-II "/>
         <ClickBoxSub  text="Unit 3-Partial Differential Equations"/>
         <ClickBoxSub  text="Unit 4-Function of Complex Variable"/>
         <ClickBoxSub  text=" Unit 5-Vector Calculus"/>
        </View>
